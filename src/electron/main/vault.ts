...
export default () => {
  ...
  ipcMain.handle('create-app-file', (_event, name: string, content: string, folderName?: string) =>
    createParseitFile(name, content, folderName)
  )
}
